...
public class Boast
{
     ...
     */
    private volatile static WeakReference<Boast> globalBoast = null;
     ...
     * @param duration
     *        How long to display the message. Either {@link } or
     *        {@link }
     */
    ...
    /**
     * Make a standard {@link Boast} that just contains a text view with the
     * text from a resource. Duration defaults to {@link }.
     *
     * @param context
     *        The context to use. Usually your {@link android.app.Application}
     *        or {@link android.app.Activity} object.
    ...
    {
        // cancel current Toast if existing and requested
        if (globalBoast != null) {
            final Boast globBoastRef = globalBoast.get();
