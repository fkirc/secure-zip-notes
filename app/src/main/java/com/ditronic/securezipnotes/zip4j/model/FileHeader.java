...
package com.ditronic.securezipnotes.zip4j.model;
...
public class FileHeader {
	...
	public String getDisplayName() {
		return CryptoZip.getDisplayName(this);
	}
	 ...
	 * @throws ZipException
	 */
	public ByteArrayOutputStream extractFile(ZipModel zipModel,
											 UnzipParameters unzipParameters,
											 ProgressMonitor progressMonitor) throws ZipException {
		if (zipModel == null) {
			throw new ZipException("input zipModel is null");
		}
		final boolean runInThread = false;
		Unzip unzip = new Unzip(zipModel);
		return unzip.extractFile(this, unzipParameters, progressMonitor, runInThread);
	}
